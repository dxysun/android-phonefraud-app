...
import com.dxy.phonefraud.callrecord.service.CallRecordService;
...
public class CallRecord {
    ...
    public static final String FILE_SAVE_PATH = "PrefDirPcm";
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            PrefsHelper.writePrefString(mContext, FILE_SAVE_PATH, "pcmpath");
        ...
        public Builder setRecordFilePath(String recordFilePath) {

            PrefsHelper.writePrefString(mContext, FILE_SAVE_PATH, recordFilePath);

            return this;
        }
        public String getRecordFilePath() {

            return PrefsHelper.readPrefString(mContext, FILE_SAVE_PATH);
        }
